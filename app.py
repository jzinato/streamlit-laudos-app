...
secoes = {
    "Bioquímica": ["potássio", "cálcio", "fósforo", "sódio", "glicose", "creatinina", "ferritina", "proteínas", "albumina", "a/g", "fosfatase", "ist", "uréia", "ácido úrico"],
    "Hematologia": ["hemoglobina", "vcm", "hcm", "plaquetas", "leucócitos", "segmentados", "bastonetes", "eosinófilos", "basófilos", "linfócitos", "monócitos"],
    "Hormônios": ["pth", "paratormônio", "tsh", "t4", "t3", "prolactina", "lh", "fsh"],
    "Vitaminas e Metabolismo Mineral": ["vitamina", "25-oh", "b12", "ácido fólico", "calcidiol", "calcitriol"],
    "Urina Tipo I": ["urina", "ph", "densidade", "corpos cetônicos", "leucócitos", "nitrito", "hemácias", "proteína", "urobilinogênio", "epiteliais", "cilindros", "bactérias"]
}
